      ...
      {showMentionDropdown &&
        (filteredArtifacts.length > 0 || filteredDocuments.length > 0) && (
          <div
            ...
            className="glass-panel absolute bottom-full left-0 mb-2 w-[580px] max-h-64 bg-white dark:bg-slate-800 border border-slate-200 dark:border-white/[0.08] rounded-lg shadow-lg z-50 overflow-hidden"
          >
            {/* Tabs */}
